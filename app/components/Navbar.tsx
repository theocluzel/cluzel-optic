    ...
    <div className="w-full relative z-[20] bg-neutral-900 text-white">
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center py-6">
          ...
          <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="md:hidden p-2 mt-4 text-white">
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-neutral-800">
            <div className="flex flex-col space-y-4">
              <a href="/" className="text-gray-100 hover:text-blue-300 transition-colors">Accueil</a>
              <a href="/#collections" className="text-gray-100 hover:text-blue-300 transition-colors">Nos Collections</a>
              {/* Immersion retiré du menu mobile */}
              <a href="/a-propos" className="text-gray-100 hover:text-blue-300 transition-colors">À propos</a>
              <a href="/temoignages" className="text-gray-100 hover:text-blue-300 transition-colors">Témoignages</a>
              <a href="/services-optiques" className="text-gray-100 hover:text-blue-300 transition-colors">Services</a>
              <a href="#contact" className="text-gray-100 hover:text-blue-300 transition-colors">Contact</a>
            </div>
          </div>
        )}
      </div>
