              ...
              <section key={section.marque} className="py-12">
                <div className="container mx-auto px-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 place-items-center justify-items-center">
                    ...
                    className="relative w-full max-w-[220px] sm:max-w-[260px] aspect-[4/3] rounded-xl shadow-lg wood-bg p-3 sm:p-3 border border-neutral-800/20"
                      >
                        <div
                          className="relative w-full h-full rounded-lg border overflow-hidden bg-white"
                          style={{
                            borderColor: '#e5e7eb',
